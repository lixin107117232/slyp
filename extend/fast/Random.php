...
class Random
{
     ...
     * @return string
     */
    public static function allCapital($len = 4)
    {
        return self::build('allCapital', $len);
    }
     ...
     * @return string
     */
    public static function allLower($len = 4)
    {
        return self::build('allLower', $len);
    }
     ...
     * @return string
     */
    public static function numericAndAllCapital($len = 4)
    {
        return self::build('numericAndAllCapital', $len);
    }
     ...
     * @return string
     */
    public static function numericAndAllLower($len = 4)
    {
        return self::build('numericAndAllLower', $len);
    }
    ...
    public static function build($type = 'alnum', $len = 8)
    {
        switch ($type) {
            case 'allCapital':
            case 'numericAndAllCapital':
            case 'allLower':
            case 'numericAndAllLower':
            case 'alpha':
            case 'alnum':
            case 'numeric':
            case 'nozero':
