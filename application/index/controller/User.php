...
class User extends Frontend
{
    ...
    protected $noNeedLogin = ['login', 'register', 'third','registers','down_page','zcxy'];
...
//        return false;
    ...
    public function registers()
    {
        if ($this->request->isPost()) {
            ...
            $password_again = $this->request->request("password_again");
            $yaoqing = $this->request->request("yaoqing");
            $xy = $this->request->request("radio");
            dump($this->request->request());die;
        }else{
            $agreement = config('site.agreement');
            $user_code = $this->request->request('user_code');
    ...
    public function down_page(){
        $android = config('site.android_url');
        $ios = config('site.ios_url');

        $this->view->assign('android', $android);
        $this->view->assign('ios', $ios);
        return $this->view->fetch();
    }
